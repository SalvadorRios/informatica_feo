...
$buscar = "SELECT * FROM recidencias WHERE id=$id_user";
...
<div class="ContForm">
    ...
    <form action="./../updates/updateRecidencias.php" method="POST" enctype="multipart/form-data">
        <div class="form-group">
            ...
            ?>
                ...
                <span id="imagenHomeHelpBlock" class="form-text text-muted">Archivo Actual: <?php echo $dat['formato'] ?></span><br>
                <input id="imagenHome" name="anterior" type="text" class="form-control" aria-describedby="imagenHomeHelpBlock" value="<?php echo $dat['formato'] ?>" hidden>
